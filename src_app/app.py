...
def bootstrap_demo_service() -> LabNKBandiService:
    ...
    grants = [
        ...
        CanonicalGrantModel(
            ...
            tipo_agevolazione="Grant + Blended Equity",
        ...
        CanonicalGrantModel(
            ...
            data_apertura=now,
            stato=BandoStato.APERTO,
            settori_beneficiari=["35.11.00", "43.21.01", "71.12.10"],
            tipologia_beneficiari=["PMI", "Micro"],
            regioni_target=["Sicilia"],
        ...
        CanonicalGrantModel(
            ...
            descrizione="Contributi a fondo perduto per riqualificazione energetica alberghi, strutture ricettive, ammodernamento e turismo sostenibile nel Veneto.",
            tipo_agevolazione="Contributo a fondo perduto",
        ...
        CanonicalGrantModel(
            ...
            descrizione="Finanziamenti a fondo perduto per economia circolare riciclo materie plastiche e riduzione scarti industriali a Perugia e in Umbria.",
            tipo_agevolazione="Contributo a fondo perduto",
            budget_totale=10000000.0,
            importo_massimo_finanziabile=100000.0,
            percentuale_copertura=55.0,
            data_apertura=now,
            stato=BandoStato.APERTO,
            settori_beneficiari=["38.32.20", "38.21.00"],
            tipologia_beneficiari=["PMI"],
        ...
        CanonicalGrantModel(
            ...
            titolo="Fondo Rotazione Finaosta Sostegno Imprese VDA — Artigianato Alpino",
            ente_erogatore="Finaosta — Regione Autonoma Valle d'Aosta",
            descrizione="Fondo di rotazione per investimenti innovativi e artigianato alpino, finanziamenti a tasso agevolato per imprese e botteghe ad Aosta e in Valle d'Aosta.",
            ...
            data_apertura=now,
            stato=BandoStato.APERTO,
            settori_beneficiari=["16.29.19", "16.29.00", "23.70.00", "31.09.00"],
            tipologia_beneficiari=["PMI"],
